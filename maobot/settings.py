"""
Django settings for maobot project.
...
SECRET_KEY = 'lrs49i2*4)kko84zu(m-0ul6r%@pzp3&euz(ak6n3ha3&5yuy1'
...
INSTALLED_APPS = [
    ...
    'imagekit',
    'mod_wsgi.server',
    'irclog.apps.IrclogConfig',
    'ircimages.apps.IrcimagesConfig',
    'accounts',
]
...
LOGIN_REDIRECT_URL = 'irclog:index'
